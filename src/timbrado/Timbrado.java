...
public class Timbrado {
  ...
  public static void main(String[] args) throws IOException {
     ...
     */
    String r = connect.timbrar(pathdir+"/ejemplos/ejemploTimbrado.xml");
    ...
    if (connect.error) {
      ...
      try {
          File archivo = new File(pathdir+"/resultados/ejemploXML_CFDI.xml");
      ...
      if (connect.generarPDF) {
        ...
        try {
          ...
          out = new FileOutputStream(pathdir+"/resultados/ejemploPDF_CFDI.pdf");
      ...
      if (connect.generarCBB) {
        ...
        try {
          ...
          out = new FileOutputStream(pathdir+"/resultados/ejemploCBB_CFDI.png");
          out.write(b, 0, b.length);
          out.close();
        }catch (Exception e) {
          System.out.println(e);
      ...
      if (connect.generarTXT) {
        ...
        try {
          File archivo = new File(pathdir+"/resultados/ejemploTXT_CFDI.txt");
          FileWriter escribir = new FileWriter(archivo);
          escribir.write(txt);
          escribir.close();
        }
